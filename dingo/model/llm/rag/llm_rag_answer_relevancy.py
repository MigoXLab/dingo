...
class EmbeddingModel:
    ...
    def __init__(self, model_name: str = "text-embedding-3-large", is_openai: bool = True):
        ...
        if is_openai:
            ...
            self.client = OpenAI(
                api_key="sk-SWPLPHhvXOAT2LRHPTfZqbOb6pI2xhp3UDtwdLBdNUXlZ3l1",
...
class LLMRAGAnswerRelevancy(BaseOpenAI):
 ...
 输出: """
    ...
    def build_messages(cls, input_data: Data) -> List:
        """构建LLM输入消息"""
        # 提取字段
        answer = input_data.content or getattr(input_data, "answer", "")
    ...
    def eval(cls, input_data: Data) -> ModelRes:
        ...
        # 提取原始问题
        original_question = input_data.prompt or getattr(input_data, "question", "")
